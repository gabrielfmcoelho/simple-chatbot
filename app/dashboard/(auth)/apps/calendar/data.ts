...
export const eventColors: Record<string, string> = {
  blue: "text-xs bg-gradient-to-r from-blue-500 to-purple-500 text-white dark:bg-blue-950 hover:bg-gradient-to-r hover:opacity-80",
  red: "text-xs bg-gradient-to-r from-red-500 to-yellow-500 text-white dark:bg-blue-950 hover:bg-gradient-to-r hover:opacity-80",
  green:
    "text-xs bg-gradient-to-r from-green-500 to-yellow-500 text-white dark:bg-blue-950 hover:bg-gradient-to-r hover:opacity-80",
  purple:
    "text-xs bg-gradient-to-r from-purple-500 to-pink-500 text-white dark:bg-blue-950 hover:bg-gradient-to-r hover:opacity-80",
  orange:
    "text-xs bg-gradient-to-r from-orange-500 to-red-500 text-white dark:bg-blue-950 hover:bg-gradient-to-r hover:opacity-80",
  teal: "text-xs bg-gradient-to-r from-teal-500 to-green-500 text-white dark:bg-blue-950 hover:bg-gradient-to-r hover:opacity-80"
};
